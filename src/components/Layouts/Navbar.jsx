        ...
        <div className="w-full max-w-[1536px]  mx-auto">
          <div className="navbar-start flex lg:block">
            <div className="drawer">
              ...
              <div className="drawer-content lg:hidden">
                <label
                  htmlFor="my-drawer"
                  className="btn bg-sky-600 drawer-button border-0 text-white"
                >
                  <svg
          ...
          <div className="navbar-end ">
            ...
            <div className="lg:hidden float-right">
              <button
                className="btn btn-circle bg-sky-600 border-0 text-white"
            ...
            <div className="dropdown dropdown-end float-right lg:px-2">
              <div
                tabIndex={0}
                role="button"
            ...
            <div className="float-right lg:px-2 pt-2">
